		...
		<div class="box box-primary">
			<div class="box-header">
				<h1>
					...
					<a href="prescriptionAdd"><button type="button" class="btn btn-default"><span class="fa fa-plus"></span> Add New</button></a>
				</h1>
			</div>
			<!-- /.box-header -->
						...
						<tr>
							...
							<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li><a href="#" data-toggle="modal" data-target="#"><span class="fa fa-pencil"></span>View</a></li>
									</ul>
							</div>
							</td>
						</tr>
